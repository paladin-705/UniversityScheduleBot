...
class TestScheduleDB(unittest.TestCase):
    ...
    def test_get_exams(self):
        ...
        real_data = [(datetime.date(2012, 9, 12), 'text_exam_1'.ljust(100), 'cr_401'.ljust(20), 'lect_1'.ljust(30)),
                     (datetime.date(2012, 10, 12), 'text_exam_2'.ljust(100), 'cr_402'.ljust(20), 'lect_2'.ljust(30)),
    ...
    def test_get_organizations(self):
        real_organizations = [('test_organization_01'.ljust(80), '1b110c6f26d3dd30429f0c0aa7d7d9'),
                              ('test_organization_02'.ljust(80), '86de8e25b7f22ce0429f0c0aa7d7d9'),
